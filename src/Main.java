...
public class Main {
    ...
    public static final String CONTACT_SHARE_NUMBER = "There are contacts that share phone numbers.";
    ...
    private static void lookupContact(Scanner in, ContactBook cBook) {
        ...
        if(cBook.findContact(phone) != null){
            System.out.println(cBook.findContact(phone).getName());
        }
        else{
    ...
    private static void checkNumber(ContactBook cBook) {
        boolean answer = cBook.existEqualNumbers();
        if (answer){
            System.out.println(CONTACT_SHARE_NUMBER);
        }
        else{
            System.out.println(CONTACT_ALL_DIFFERENT);
        }
